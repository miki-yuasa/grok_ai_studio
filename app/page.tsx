...
export default function Landing() {
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-6 rounded-2xl bg-muted">
              ...
              <p className="text-sm text-muted-foreground">
                Leverage Grok AI to create viral marketing strategies and
                engaging tweet content.
              </p>
            </div>
            <div className="p-6 rounded-2xl bg-muted">
              <div className="w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center mb-4">
              ...
              <p className="text-sm text-muted-foreground">
                Create stunning video ads with Google Veo AI for maximum
                engagement.
              </p>
            </div>
            <div className="p-6 rounded-2xl bg-muted">
              ...
              <p className="text-sm text-muted-foreground">
                Schedule your campaigns and let our system post automatically at
                optimal times.
              </p>
            </div>
          </div>
      ...
      <footer
        id="contact"
        className="bg-card border-t border-border px-8 py-16"
      >
        <div className="mx-auto grid max-w-6xl grid-cols-1 gap-12 md:grid-cols-3">
          ...
          <div>
            ...
            <h2 className="text-4xl font-medium leading-tight md:text-5xl text-foreground">
              Let's start
              <br />
              creating
              <br />
        ...
        <div className="mx-auto max-w-6xl mt-12 pt-8 border-t border-border">
          <p className="text-sm text-muted-foreground text-center">
            Built with Grok and X API
          </p>
        </div>
      </footer>
    </div>
